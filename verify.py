"""
Verify the database layer against the figures recorded in the project spec.

Run after ./rebuild_db.sh:

    python3 verify.py

Every expectation here is quoted from the project spec section 4 and is reproducible.
...
Note that this file queries `Vaccination` directly, which the project spec rule 7.1
