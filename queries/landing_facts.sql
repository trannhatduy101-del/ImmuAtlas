...
SELECT
    ...
    -- counted here, because they reported (the project spec 4.4).
    ...
    -- this figure is unaffected by the reported-zero question of the project spec 4.3.
